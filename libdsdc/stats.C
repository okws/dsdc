...
namespace dsdc {
  ...
  namespace annotation {
	...
	_alltime._rm_explicit ++; _per_epoch._rm_explicit ++;
	break;
      case REMOVE_MAKE_ROOM:
	_alltime._rm_make_room ++; _per_epoch._rm_make_room ++;
	break;
      case REMOVE_CLEAN:
	_alltime._rm_clean++; _per_epoch._rm_clean++;
	break;
      case REMOVE_REPLACE:
	_alltime._rm_replace ++; _per_epoch._rm_replace ++; 
	break;
      default:
	break;
      }
